...
var livro_1 = __importDefault(require("./model/livro"));
var livro = new livro_1.default('Dom Quixote', 108.8, 0.1);
console.log(livro.precoComDesconto());
(0, jquery_1.default)('body').append("<h1>" + livro.nome + "</h1>");
(0, jquery_1.default)('body').append("<h2>" + livro.precoComDesconto() + "</h2>");

},{"./model/livro":3,"jquery":1}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
